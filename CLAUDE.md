...
- **A GUARD ON THE WRAPPER IS NOT A GUARD ON THE VALUE** (G.2, 2026-08-25).
  ...
  see it. Closed with a literal pin (one degree = 111.195080 km, vs
  111.194927 on the old earth). **Where this DOES NOT belong, checked before
...
- Per-task walkthroughs are in `docs/walkthroughs/` (`phase-0-and-E1.1.md`, `E1.2.md`
  ...
  Track G's `G.3.md` and `G.2.md`). **The Phase-4/5 and Track-G files were
